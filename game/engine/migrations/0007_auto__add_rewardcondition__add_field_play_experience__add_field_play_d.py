...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RewardCondition'
        db.create_table('engine_rewardcondition', (
            ...
            ('condition', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('engine', ['RewardCondition'])

        # Adding field 'Play.experience'
        db.add_column('engine_play', 'experience', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Play.description'
        db.add_column('engine_play', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RewardCondition'
        db.delete_table('engine_rewardcondition')

        # Deleting field 'Play.experience'
        db.delete_column('engine_play', 'experience')

        # Deleting field 'Play.description'
        db.delete_column('engine_play', 'description')
