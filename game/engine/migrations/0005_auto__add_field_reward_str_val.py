...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reward.str_val'
        db.add_column('engine_reward', 'str_val', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reward.str_val'
        db.delete_column('engine_reward', 'str_val')
