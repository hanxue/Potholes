...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('engine_actionlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engine.Character'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engine.Action'])),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('engine', ['ActionLog'])

        # Changing field 'RewardCondition.action'
        db.alter_column('engine_rewardcondition', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engine.Action']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('engine_actionlog')

        # Changing field 'RewardCondition.action'
        db.alter_column('engine_rewardcondition', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engine.Play']))
