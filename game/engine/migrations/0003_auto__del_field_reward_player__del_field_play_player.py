...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Reward.player'
        db.delete_column('engine_reward', 'player_id')

        # Deleting field 'Play.player'
        db.delete_column('engine_play', 'player_id')


    def backwards(self, orm):
        
        # Adding field 'Reward.player'
        db.add_column('engine_reward', 'player', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['engine.Character']), keep_default=False)

        # Adding field 'Play.player'
        db.add_column('engine_play', 'player', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['engine.Character']), keep_default=False)
